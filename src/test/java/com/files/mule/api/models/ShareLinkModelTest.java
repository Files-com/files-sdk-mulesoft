...
public class ShareLinkModelTest {
  ...
  public void testShareLinkModel() {
    ...
    model.setPasswordProtected(false);
    assertThat(model.getPasswordProtected(), equalTo(false));
    model.setPermissions("read");
    assertThat(model.getPermissions(), equalTo("read"));
    model.setPreviewOnly(false);
    assertThat(model.getPreviewOnly(), equalTo(false));
    model.setRequireRegistration(false);
    assertThat(model.getRequireRegistration(), equalTo(false));
    model.setRequireShareRecipient(false);
    assertThat(model.getRequireShareRecipient(), equalTo(false));
    ...
    model.setBypassesSiteExpirationRules(true);
