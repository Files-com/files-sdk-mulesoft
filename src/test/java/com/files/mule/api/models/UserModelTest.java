...
public class UserModelTest {
  ...
  public void testUserModel() {
    ...
    model.setNotifyOnAllSiteWarnings(true);
    assertThat(model.getNotifyOnAllSiteWarnings(), equalTo(true));
    model.setNotifyOnAllSsoFailures(true);
    assertThat(model.getNotifyOnAllSsoFailures(), equalTo(true));
    model.setNotifyOnAllUserSecurityEvents(true);
    assertThat(model.getNotifyOnAllUserSecurityEvents(), equalTo(true));
    model.setNotifyOnAllPendingWorkFailures(true);
    assertThat(model.getNotifyOnAllPendingWorkFailures(), equalTo(true));
    model.setNotifyOnAllSiemHttpDestinationFailures(true);
    assertThat(model.getNotifyOnAllSiemHttpDestinationFailures(), equalTo(true));
    model.setNotifyOnAllSyncFailures(true);
    assertThat(model.getNotifyOnAllSyncFailures(), equalTo(true));
    model.setNotifyOnAllAutomationFailures(true);
    assertThat(model.getNotifyOnAllAutomationFailures(), equalTo(true));
    model.setNotifyOnAllExpectationFailures(true);
    assertThat(model.getNotifyOnAllExpectationFailures(), equalTo(true));
    ...
    model.setDefaultWorkspaceId(1L);
    assertThat(model.getDefaultWorkspaceId(), equalTo(1L));
